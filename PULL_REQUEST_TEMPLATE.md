...
Describe the change in 2-5 sentences. Be explicit about whether it affects the public CLI, JSON or JSONL artifacts, prompt behavior, or only internal implementation details.
...
- [ ] I updated relevant documentation, examples, or command help for user-facing changes.
- [ ] I added or updated tests for non-trivial behavior changes, or explained why not.
- [ ] I called out any CLI, schema, prompt, dependency, or performance impact.
