...
nuggetizer_vllm = Nuggetizer(
    model="Qwen/Qwen3-8B-A3B-Instruct-2507",  # Model name as served by vLLM
...
python3 examples/e2e.py --model "Qwen/Qwen3-8B-A3B-Instruct-2507" --use_vllm

# Use vLLM with custom port (8001)
python3 examples/e2e.py --model "Qwen/Qwen3-8B-A3B-Instruct-2507" --use_vllm --vllm_port 8001
```
...
```bash
# Use vLLM with default port (8000)
python3 examples/async_e2e.py --model "Qwen/Qwen3-8B-A3B-Instruct-2507" --use_vllm

# Use vLLM with custom port (8001)
python3 examples/async_e2e.py --model "Qwen/Qwen3-8B-A3B-Instruct-2507" --use_vllm --vllm_port 8001
```
